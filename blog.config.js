...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'c8ae996296d540cf88482d02ebfa09c0',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Every star is a DREAM,Stars fallen, so,My Dream\'s waked,欢迎参观我的梦🌃',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Marno', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '帅比', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.manro.space', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Marno-o', // 你的github个人主页 例如 https://github.com/tangly1024
